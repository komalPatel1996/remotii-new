<?php
/**
 * This file is serve to remove inbound data
 */
...
$response = file_get_contents('http://'.$servers[$server_id].'/admin/index/cron-rmib-data');

/**
 * Uncomment the following to generate logs
 */
//error_log ( time().":\n".json_decode($response)."\n", 3, '/var/www/remotii/public/cron-remove-inbound.log' );
